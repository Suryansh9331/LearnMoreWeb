...
export default function SuspiciousActivityAlert() {
  ...
  const handleLearnMore = () => {
    ...
    alert(
      "Learn more clicked! This would typically redirect to a security help page."
    );
  };
  ...
  "
          >
            It looks like someone else may be using your{" "}
            <span className="font-bold">Facebook account.</span>
